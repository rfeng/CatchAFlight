...
module CatchAFlight
  ...
  def generate_planes(map, num_planes = 1000, min_speed = 0, max_speed = 3)
  ...
  def simulate(map, cal)
    ...
    while true # main simulation loop
      ...
      planes_in_flight.each do |plane|
        plane.land if (t - plane.boarding_time) * plane.speed > plane.distance_to_travel
      end
    end
  end
end
